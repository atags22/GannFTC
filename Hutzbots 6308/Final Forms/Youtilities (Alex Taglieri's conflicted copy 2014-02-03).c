...
//////////////////////////////////////////////////
/*
void AverageGetRobotAngle(int attempts = 50)
{
	...
	robotAngle = round((float)robotAngle / (float)(attempts+1));
}
*/
/*
float EncoderDegreeChange()
{
	int SinwheelsRotated, CoswheelsRotated;
	SinwheelsRotated = nMotorEncoder[FL] - nMotorEncoder[BR];
	CoswheelsRotated = nMotorEncoder[BL] - nMotorEncoder[FR];

	float DeltaEncoder = (SinwheelsRotated + CoswheelsRotated) / 2.0;
	return DeltaEncoder;
}
*/
