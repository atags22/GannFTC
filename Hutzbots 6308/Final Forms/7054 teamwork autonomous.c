...
// 2: rotate 45 side
#define STAGE_3  7560 // total distance
// 3: place block
// 4: sub from stopped block
#define STAGE_6  4900 // sideways
...
void stageDrive(long distance, int speed)
{
	//driveType = 1;
	//desiredSpeed = speed; desiredDistance = distance;
	stageSide(distance, 3.0 * PI, speed);
}
	...
	while (true)
	{
		...
		switch (Stage)
		{
			...
			case 1:
				...
				//stageDrive(STAGE_1, 60);
				stageSide(4400, 2*PI, 69);
				break;

			case 2:
				stageSide(2700, PI, 60);
				break;
		...
		bMotorReflected[FR] = true;
			...
			//////////////////////
			case 6:
				stageSide(STAGE_6, 2 *PI, 70);
				break;

			// Go backwards
			///////////////
			case 7:
				stageSide(STAGE_7, PI, 80);
				break;
